...
type FlowFilter struct {
	...
	xxx_hidden_ReverseOrder bool                   `protobuf:"varint,7,opt,name=reverse_order,json=reverseOrder"`
...
func (x *FlowFilter) GetReverseOrder() bool {
	if x != nil {
...
func (x *FlowFilter) SetReverseOrder(v bool) {
...
func (x *FlowFilter) HasReverseOrder() bool {
	if x == nil {
		return false
	}
...
func (x *FlowFilter) ClearReverseOrder() {
...
const file_mitmflow_v1_mitmflow_proto_rawDesc = "" +
	"\n" +
	"\x1amitmflow/v1/mitmflow.proto\x12\vmitmflow.v1\x1a\x1emitmproxygrpc/v1/service.proto\x1a\x1bbuf/validate/validate.proto\"\xa8\x02\n" +
	"\n" +
	"FlowFilter\x12\x1f\n" +
	...
	"\x04http\x18\x06 \x01(\v2\x17.mitmflow.v1.HttpFilterR\x04http\x12#\n" +
	"\rreverse_order\x18\a \x01(\bR\freverseOrder\"X\n" +
