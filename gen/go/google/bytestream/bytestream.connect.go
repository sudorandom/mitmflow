...
type ByteStreamClient interface {
	...
	Read(context.Context, *connect.Request[ReadRequest]) (*connect.ServerStreamForClient[ReadResponse], error)
	...
	// `complete` or not.
	Write(context.Context) *connect.ClientStreamForClient[WriteRequest, WriteResponse]
	...
	// non-decreasing.
	QueryWriteStatus(context.Context, *connect.Request[QueryWriteStatusRequest]) (*connect.Response[QueryWriteStatusResponse], error)
}
...
func NewByteStreamClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ByteStreamClient {
	...
	byteStreamMethods := File_google_bytestream_bytestream_proto.Services().ByName("ByteStream").Methods()
	return &byteStreamClient{
		read: connect.NewClient[ReadRequest, ReadResponse](
			httpClient,
			baseURL+ByteStreamReadProcedure,
			connect.WithSchema(byteStreamMethods.ByName("Read")),
			connect.WithClientOptions(opts...),
		),
		write: connect.NewClient[WriteRequest, WriteResponse](
			httpClient,
			baseURL+ByteStreamWriteProcedure,
			connect.WithSchema(byteStreamMethods.ByName("Write")),
			connect.WithClientOptions(opts...),
		),
		queryWriteStatus: connect.NewClient[QueryWriteStatusRequest, QueryWriteStatusResponse](
			httpClient,
...
type byteStreamClient struct {
	...
	queryWriteStatus *connect.Client[QueryWriteStatusRequest, QueryWriteStatusResponse]
}

// Read calls google.bytestream.ByteStream.Read.
func (c *byteStreamClient) Read(ctx context.Context, req *connect.Request[ReadRequest]) (*connect.ServerStreamForClient[ReadResponse], error) {
	return c.read.CallServerStream(ctx, req)
}

// Write calls google.bytestream.ByteStream.Write.
func (c *byteStreamClient) Write(ctx context.Context) *connect.ClientStreamForClient[WriteRequest, WriteResponse] {
	return c.write.CallClientStream(ctx)
}

// QueryWriteStatus calls google.bytestream.ByteStream.QueryWriteStatus.
func (c *byteStreamClient) QueryWriteStatus(ctx context.Context, req *connect.Request[QueryWriteStatusRequest]) (*connect.Response[QueryWriteStatusResponse], error) {
...
type ByteStreamHandler interface {
	...
	// of bytes. The bytes are returned in a sequence of responses, and the
	// responses are delivered as the results of a server-side streaming RPC.
	Read(context.Context, *connect.Request[ReadRequest], *connect.ServerStream[ReadResponse]) error
	// `Write()` is used to send the contents of a resource as a sequence of
	// bytes. The bytes are sent in a sequence of request protos of a client-side
	// streaming RPC.
	//
	...
	// service was able to commit and whether the service views the resource as
	// `complete` or not.
	Write(context.Context, *connect.ClientStream[WriteRequest]) (*connect.Response[WriteResponse], error)
	// `QueryWriteStatus()` is used to find the `committed_size` for a resource
	// that is being written, which can then be used as the `write_offset` for
	// the next `Write()` call.
	//
...
func (UnimplementedByteStreamHandler) Read(context.Context, *connect.Request[ReadRequest], *connect.ServerStream[ReadResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("google.bytestream.ByteStream.Read is not implemented"))
}

func (UnimplementedByteStreamHandler) Write(context.Context, *connect.ClientStream[WriteRequest]) (*connect.Response[WriteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("google.bytestream.ByteStream.Write is not implemented"))
}

func (UnimplementedByteStreamHandler) QueryWriteStatus(context.Context, *connect.Request[QueryWriteStatusRequest]) (*connect.Response[QueryWriteStatusResponse], error) {
