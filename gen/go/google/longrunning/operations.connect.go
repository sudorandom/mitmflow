...
type OperationsClient interface {
	...
	ListOperations(context.Context, *connect.Request[ListOperationsRequest]) (*connect.Response[ListOperationsResponse], error)
	// Gets the latest state of a long-running operation.  Clients can use this
	// method to poll the operation result at intervals as recommended by the API
	// service.
	GetOperation(context.Context, *connect.Request[GetOperationRequest]) (*connect.Response[Operation], error)
	// Deletes a long-running operation. This method indicates that the client is
	// no longer interested in the operation result. It does not cancel the
	// operation. If the server doesn't support this method, it returns
	// `google.rpc.Code.UNIMPLEMENTED`.
	DeleteOperation(context.Context, *connect.Request[DeleteOperationRequest]) (*connect.Response[emptypb.Empty], error)
	...
	// `Code.CANCELLED`.
	CancelOperation(context.Context, *connect.Request[CancelOperationRequest]) (*connect.Response[emptypb.Empty], error)
	...
	WaitOperation(context.Context, *connect.Request[WaitOperationRequest]) (*connect.Response[Operation], error)
}
...
func NewOperationsClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) OperationsClient {
	...
	operationsMethods := File_google_longrunning_operations_proto.Services().ByName("Operations").Methods()
	return &operationsClient{
		listOperations: connect.NewClient[ListOperationsRequest, ListOperationsResponse](
			httpClient,
			baseURL+OperationsListOperationsProcedure,
			connect.WithSchema(operationsMethods.ByName("ListOperations")),
			connect.WithClientOptions(opts...),
		),
		getOperation: connect.NewClient[GetOperationRequest, Operation](
			httpClient,
			baseURL+OperationsGetOperationProcedure,
			connect.WithSchema(operationsMethods.ByName("GetOperation")),
			connect.WithClientOptions(opts...),
		),
		deleteOperation: connect.NewClient[DeleteOperationRequest, emptypb.Empty](
			httpClient,
			baseURL+OperationsDeleteOperationProcedure,
			connect.WithSchema(operationsMethods.ByName("DeleteOperation")),
			connect.WithClientOptions(opts...),
		),
		cancelOperation: connect.NewClient[CancelOperationRequest, emptypb.Empty](
			httpClient,
			baseURL+OperationsCancelOperationProcedure,
			connect.WithSchema(operationsMethods.ByName("CancelOperation")),
			connect.WithClientOptions(opts...),
		),
		waitOperation: connect.NewClient[WaitOperationRequest, Operation](
			httpClient,
...
type operationsClient struct {
	listOperations  *connect.Client[ListOperationsRequest, ListOperationsResponse]
	getOperation    *connect.Client[GetOperationRequest, Operation]
	deleteOperation *connect.Client[DeleteOperationRequest, emptypb.Empty]
	cancelOperation *connect.Client[CancelOperationRequest, emptypb.Empty]
	waitOperation   *connect.Client[WaitOperationRequest, Operation]
}

// ListOperations calls google.longrunning.Operations.ListOperations.
func (c *operationsClient) ListOperations(ctx context.Context, req *connect.Request[ListOperationsRequest]) (*connect.Response[ListOperationsResponse], error) {
	return c.listOperations.CallUnary(ctx, req)
}

// GetOperation calls google.longrunning.Operations.GetOperation.
func (c *operationsClient) GetOperation(ctx context.Context, req *connect.Request[GetOperationRequest]) (*connect.Response[Operation], error) {
	return c.getOperation.CallUnary(ctx, req)
}

// DeleteOperation calls google.longrunning.Operations.DeleteOperation.
func (c *operationsClient) DeleteOperation(ctx context.Context, req *connect.Request[DeleteOperationRequest]) (*connect.Response[emptypb.Empty], error) {
	return c.deleteOperation.CallUnary(ctx, req)
}

// CancelOperation calls google.longrunning.Operations.CancelOperation.
func (c *operationsClient) CancelOperation(ctx context.Context, req *connect.Request[CancelOperationRequest]) (*connect.Response[emptypb.Empty], error) {
	return c.cancelOperation.CallUnary(ctx, req)
}

// WaitOperation calls google.longrunning.Operations.WaitOperation.
func (c *operationsClient) WaitOperation(ctx context.Context, req *connect.Request[WaitOperationRequest]) (*connect.Response[Operation], error) {
...
func (UnimplementedOperationsHandler) ListOperations(context.Context, *connect.Request[ListOperationsRequest]) (*connect.Response[ListOperationsResponse], error) {
...
func (UnimplementedOperationsHandler) GetOperation(context.Context, *connect.Request[GetOperationRequest]) (*connect.Response[Operation], error) {
...
func (UnimplementedOperationsHandler) DeleteOperation(context.Context, *connect.Request[DeleteOperationRequest]) (*connect.Response[emptypb.Empty], error) {
...
func (UnimplementedOperationsHandler) CancelOperation(context.Context, *connect.Request[CancelOperationRequest]) (*connect.Response[emptypb.Empty], error) {
...
func (UnimplementedOperationsHandler) WaitOperation(context.Context, *connect.Request[WaitOperationRequest]) (*connect.Response[Operation], error) {
